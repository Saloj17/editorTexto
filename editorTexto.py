...
class Editor(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title('Saloj - Editor de Texto')
        # Configuración tamaño mínimo de la ventana
        self.rowconfigure(0,minsize=600, weight=1)
        # Configuramos mínima de la segunda columna
    ...
    def _crear_componentes(self):
        ...
        # Los botones se expanden de forma horizontal (sticky = 'we')
        ...
        # Se coloca el frame de forma vertical
        frame_botones.grid(row=0, column=0, sticky= 'ns')
        # Agregamos el campo de texto, se expandirá por completo en el espacio que reste.
